...
<input class="w-5 h-5 rounded-DEFAULT border-2 border-outline-variant bg-surface-container-low text-primary-container focus:ring-primary focus:ring-offset-background checked:border-primary-container cursor-pointer transition-colors" name="remember" type="checkbox"/>
<span class="font-body-md text-on-surface-variant group-hover:text-on-surface transition-colors">Remember me</span>
</label>
<a class="font-body-md text-secondary hover:text-primary font-medium hover:underline underline-offset-4 transition-colors" href="#">Forgot Password?</a>
</div>
<!-- Submit Button -->
<button class="mt-4 w-full py-3.5 bg-primary-container hover:bg-primary text-on-primary rounded-lg font-body-md font-medium transition-colors btn-shadow flex items-center justify-center gap-2" type="submit">
                        Sign In to Archive
...
<p class="font-body-md text-on-surface-variant">
                        New User? 
                        <a class="text-primary font-medium hover:underline underline-offset-4 transition-all decoration-primary/30 hover:decoration-primary" href="{{ url('signup') }}">Create an Account</a>
</p>
</div>
</div>
</div>
